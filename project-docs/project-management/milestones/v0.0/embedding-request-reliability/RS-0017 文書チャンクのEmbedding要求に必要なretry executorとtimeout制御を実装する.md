...
- `design/リトライ・タイムアウト設計.md`に、対象operationのPolicy、timeout、エラー分類、ログevent、テスト方針が記載されている
...
- [ ] 実装で具体化または変更された現在設計が`design/リトライ・タイムアウト設計.md`と`design/エラー・ログ設計.md`へ反映されている
