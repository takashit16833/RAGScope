...
- `design/logging/実行追跡・構造化ログ契約設計.md`は、本ADR採用後に`trace`、`span`、Span Status、構造化ログ、イベント、重要度、`error_type`の関係を定義していた設計書であり、現在は削除されている。現在設計は[Observability設計](../design/observability/README.md)を参照する。
